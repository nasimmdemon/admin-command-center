/**
 * ISO 3166-1 alpha-2, alpha-3, and common names for all countries.
 * Used for intelligent country input with autocomplete.
 */
...
export const COUNTRY_DATA: CountryEntry[] = [
  ...
  { alpha2: "BQ", alpha3: "BES", name: "Caribbean Netherlands" },
