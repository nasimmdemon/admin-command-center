  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <div className="border-2 border-dashed border-border/60 rounded-xl p-8 text-center hover:border-primary/50 hover:bg-tint-blue/30 transition-all duration-300 cursor-pointer">
