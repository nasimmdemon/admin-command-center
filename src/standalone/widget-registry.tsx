...
const CREATE_BRAND_WIDGETS: WidgetDef[] = [
  ...
  { id: "step-transform-emails", name: "Step 12: Transform Emails", category: "create-brand", component: <CreateBrandDemos.StepTransformEmailsDemo />, description: "Email automation" },
